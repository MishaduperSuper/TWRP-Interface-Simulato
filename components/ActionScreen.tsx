...
const ActionScreen: React.FC<ActionScreenProps> = ({ title, description, actionText, onConfirm, actionType }) => {
    ...
    return (
        <div className="p-4 flex flex-col flex-grow justify-between">
            <div>
                <h2 className="text-xl font-bold p-3 border-b-2 border-cyan-500 mb-4">{title}</h2>
            ...
            <div className="mt-auto mb-4">
                ...
                <button
                    ...
                    className="w-full py-4 bg-cyan-600 hover:bg-cyan-700 text-white font-bold rounded-lg transition-colors text-xl shadow-lg"
                >
                    {actionText}
                </button>
            </div>
